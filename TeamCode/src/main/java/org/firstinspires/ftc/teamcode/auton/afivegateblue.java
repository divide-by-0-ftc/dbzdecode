...
@Config
@Autonomous(name = "ablue5gate")
public class afivegateblue extends DbzOpMode {
...
//                    .setLinearHeadingInterpolation(Math.toRadians(270), Math.toRadians(-124))
            ...
            Path2 = f.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(54.900, 77.100),
                                    new Pose(41.761, 59.421),
                                    new Pose(20.469, 61.450)
                            )
                    ).setTangentHeadingInterpolation()
