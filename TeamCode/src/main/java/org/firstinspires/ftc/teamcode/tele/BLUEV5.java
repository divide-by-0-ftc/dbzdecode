...
public class BLUEV5 extends DbzOpMode {
    ...
    public void opLoop() {
        ...
        if (robotPose != null) telemetrym.addData("dist",
                Math.hypot(goalx - robotPose.getX(), goaly - robotPose.getY()));
    ...
    private void updateVision() {
        ...
        boolean moving = driveV > llMaxDriveV || Math.abs(llRotVelRad) > llMaxRotV || Math.abs(llTurretVelDeg) > llMaxTurretV;
