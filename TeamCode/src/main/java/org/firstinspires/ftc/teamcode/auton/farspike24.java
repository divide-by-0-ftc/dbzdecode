...
public class farspike24 extends DbzOpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower f) {
            ...
            Path2  = f.pathBuilder().addPath(new BezierCurve(new Pose(144-98.149, 83.168), new Pose(144-110.518, 62.028), new Pose(144-133.642, 58.482))).setTangentHeadingInterpolation().build();
            Path3  = f.pathBuilder().addPath(new BezierLine(new Pose(144-130.642, 58.482), new Pose(144-100.149, 77.168))).setTangentHeadingInterpolation().setReversed().build();
            Path4  = f.pathBuilder().addPath(new BezierCurve(new Pose(144-97.149, 77.168), new Pose(144-115.990, 60.361), new Pose(gatex, gatey))).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180-gateh)).build();
            Path5  = f.pathBuilder().addPath(new BezierCurve(new Pose(gatex, gatey), new Pose(144-110.990, 60.361), new Pose(144-102.149, 72.168))).setLinearHeadingInterpolation(Math.toRadians(180-gateh), Math.toRadians(180)).build();
            Path6  = f.pathBuilder().addPath(new BezierCurve(new Pose(144-102.149, 72.168), new Pose(144-110.990, 60.361), new Pose(gatex, gatey))).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180-gateh)).build();
            Path7  = f.pathBuilder().addPath(new BezierCurve(new Pose(gatex, gatey), new Pose(144-110.990, 60.361), new Pose(144-102.149, 72.168))).setLinearHeadingInterpolation(Math.toRadians(180-gateh), Math.toRadians(180)).build();
            Path8  = f.pathBuilder().addPath(new BezierCurve(new Pose(144-102.149, 72.168), new Pose(144-110.990, 60.361), new Pose(gatex, gatey))).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180-gateh)).build();
            Path9  = f.pathBuilder().addPath(new BezierCurve(new Pose(gatex, gatey), new Pose(144-110.990, 60.361), new Pose(144-102.149, 72.168))).setLinearHeadingInterpolation(Math.toRadians(180-gateh), Math.toRadians(180)).build();
            Path14 = f.pathBuilder().addPath(new BezierCurve(new Pose(144-102.149, 72.168), new Pose(144-110.990, 60.361), new Pose(gatex, gatey))).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180-gateh)).build();
            Path15 = f.pathBuilder().addPath(new BezierCurve(new Pose(gatex, gatey), new Pose(144-110.990, 60.361), new Pose(144-102.149, 79.566))).setLinearHeadingInterpolation(Math.toRadians(180-gateh), Math.toRadians(180)).build();
            Path10 = f.pathBuilder().addPath(new BezierLine(new Pose(144-102.149, 79.566), new Pose(144-128.573, 84.566))).setTangentHeadingInterpolation().build();
            Path11 = f.pathBuilder()
                    ...
                    .build();
            Path12 = f.pathBuilder().addPath(new BezierCurve(new Pose(144-95.149, 84.168), new Pose(144-110.251, 38.730), new Pose(12, 28.591))).setTangentHeadingInterpolation().build();
            Path13 = f.pathBuilder().addPath(new BezierLine(new Pose(12, 28.591), new Pose(144-96.5, 112.0))).setTangentHeadingInterpolation().setReversed().build();
        }
    }
