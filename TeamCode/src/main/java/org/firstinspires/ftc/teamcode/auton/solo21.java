...
@Config
@Autonomous(name = "red21")
public class solo21 extends DbzOpMode
{
    ...
    public static double revdebounce       = 1.7;
    ...
    public static double tG = 0.2,  tS = 0.10;



    public static double gatex =  144-12.75, gatey = 60.499, gateh = 180+151;


    public static double secondspikeshootx= 144-55.85, secondspikeshooty= 81.00;
    public static double shootx =  144-58.85, shooty = 81.0;
    ...
    public static double neargatex = 144 - 17.0, neargatey = 61.55;



    public static double hood1  = 0.47, vel1  = 1500, turret1  = 155;
    public static double hood3  = 0.46, vel3  = 1570, turret3  = -140.3;
    public static double hood5  = 0.53, vel5  = 1570, turret5  = -107.5;
    public static double hood7  = 0.53, vel7  = 1570, turret7  = -107.5;
    public static double hood9  = 0.53, vel9  = 1550, turret9  = -107.5;
    public static double hood11 = 0.53, vel11 = 1570, turret11 = -107.5;
    public static double hood13 = 0.53, vel13 = 1570, turret13 = -107.5;

    public static double hood15 = 0.53, vel15 = 1450, turret15 = -107.5;



    public static double hoodrest   = 0.53, velrest   = 1520, turretrest = -107.5;



    public static double parkx = 144-25, parky = shooty;
    ...
    public static class Paths
    {
        ...
        public Paths(Follower f)
        {
            ...
            Path1 = f.pathBuilder()
                    .addPath(new BezierLine(new Pose(startx, starty), new Pose(96.4, 86.5)))
                    .setTangentHeadingInterpolation().setReversed().build();



            Path2 = f.pathBuilder()
                    .addPath(new BezierLine(new Pose(96.4, 86.5), new Pose(123, 86.5)))
                    .setTangentHeadingInterpolation().build();



            Path3 = f.pathBuilder()
                    .addPath(new BezierLine(new Pose(129, 86.5), new Pose(87, 76)))
                    .setTangentHeadingInterpolation().setReversed().build();



            Path4 = f.pathBuilder()
                    .addPath(new BezierCurve(new Pose(87, 74),
                            new Pose(110.990, 63.89961), new Pose(123.6433, 65.99)))
                    .setTangentHeadingInterpolation().build();



            Path5 = f.pathBuilder()
                    .addPath(new BezierLine(new Pose(127.0, 61.4), new Pose(secondspikeshootx, secondspikeshooty)))
                    .setTangentHeadingInterpolation().setReversed().build();
            ...
            Path8  = gatePath(f, shootx, shooty, gatex, gatey);
            Path9  = returnPath(f, gatex, gatey, shootx, shooty);
            Path10 = gatePath(f, shootx, shooty, gatex, gatey);
            Path11 = returnPath(f, gatex, gatey, shootx, shooty);
            Path12 = gatePath(f, shootx, shooty, gatex, gatey);
            Path13 = returnPath(f, gatex, gatey, shootx, shooty);
            ...
            Path14 = f.pathBuilder()
                    .addPath(new BezierLine(new Pose(shootx, shooty), new Pose(gatex - 5, gatey)))
                    .setTangentHeadingInterpolation().build();
        }
        ...
        switch (state)
        {
            ...
            case followPath1:
                if (follower.getCurrentTValue() > 0.95)
                {
                    ...
                    startshoot();
                    statetimer.reset();
                    state = solo21.AutonState.shoot1;
                }
                break;
            ...
            case shoot1:
                if (statetimer.seconds() >= 0.7)
                {
                    ...
                    state = solo21.AutonState.followPath2;
                }
                break;
            ...
            case followPath2:
                ...
                if (follower.getCurrentTValue() > 0.95)
                {
                    ...
                    state = solo21.AutonState.followPath3;
                }
                break;
            ...
            case followPath3:
                ...
                if (follower.getCurrentTValue() > 0.95)
                {
                    ...
                    startshoot();
                    statetimer.reset();
                    state = solo21.AutonState.shoot3;
                }
                break;
            ...
            case shoot3:
                if (statetimer.seconds() >= 0.7)
                {
                    ...
                    state = solo21.AutonState.followPath4;
                }
                break;
            ...
            case followPath4:
                ...
                {
                    statetimer.reset();
                    state = solo21.AutonState.gateclear;
                    hold.setPosition(holdopen);
                }
                break;
            ...
            case gateclear:
                if (statetimer.seconds() >= 0.2)
                {
                    ...
                    state = solo21.AutonState.followPath5;
                }
                break;
            ...
            case followPath5:
                ...
                if (follower.getCurrentTValue() > 0.95)
                {
                    startshoot();
                    statetimer.reset();
                    state = solo21.AutonState.shoot5;
                }
                break;
            ...
            case shoot5:
                if (statetimer.seconds() >= 0.7)
                {
                    ...
                    state = solo21.AutonState.followPath6;
                }
                break;
            ...
            case followPath6:
                ...
                if (!follower.isBusy())
                {
                    statetimer.reset();
                    hold.setPosition(holdclose);
                    state = solo21.AutonState.intakeWait2;
                }
                break;
            ...
            case intakeWait2:
                ...
                if (bstate == solo21.BallState.locked || statetimer.seconds() >= 0.71)
                {
                    bstate = solo21.BallState.idle;
                    prevdetect = false;
                    follower.followPath(paths.Path7);
                    state = solo21.AutonState.followPath7;
                }
                break;
            ...
            case followPath7:
                ...
                if (follower.getCurrentTValue() > 0.95)
                {
                    ...
                    intake.setPower(1);
                    statetimer.reset();
                    state = solo21.AutonState.shoot7;
                }
                break;
            ...
            case shoot7:
                if (statetimer.seconds() >= 0.3)
                {
                    ...
                    state = solo21.AutonState.followPath8;
                }
                break;
            ...
            case followPath8:
                ...
                {
                    statetimer.reset();
                    state = solo21.AutonState.intakeWait3;
                }
                break;
            ...
            case intakeWait3:
                ...
                if (bstate == solo21.BallState.locked || statetimer.seconds() >= 0.71)
                {
                    ...
                    state = solo21.AutonState.followPath9;
                }
                break;
            ...
            case followPath9:
                ...
                if (follower.getCurrentTValue() > 0.95)
                {
                    ...
                    intake.setPower(1);
                    statetimer.reset();
                    state = solo21.AutonState.shoot9;
                }
                break;
            ...
            case shoot9:
                if (statetimer.seconds() >= 0.7)
                {
                    ...
                    state = solo21.AutonState.followPath10;
                }
                break;
            ...
            case followPath10:
                ...
                {
                    statetimer.reset();
                    state = solo21.AutonState.intakeWait4;
                }
                break;
            ...
            case intakeWait4:
                ...
                if (bstate == solo21.BallState.locked || statetimer.seconds() >= 0.71)
                {
                    ...
                    state = solo21.AutonState.followPath11;
                }
                break;
            ...
            case followPath11:
                ...
                if (follower.getCurrentTValue() > 0.95)
                {
                    ...
                    intake.setPower(1);
                    statetimer.reset();
                    state = solo21.AutonState.shoot11;
                }
                break;
            ...
            case shoot11:
                if (statetimer.seconds() >= 0.7)
                {
                    ...
                    state = solo21.AutonState.followPath12;
                }
                break;
            ...
            case followPath12:
                ...
                {
                    statetimer.reset();
                    state = solo21.AutonState.intakeWait5;
                }
                break;
            ...
            case intakeWait5:
                ...
                if (bstate == solo21.BallState.locked || statetimer.seconds() >= 0.71)
                {
                    ...
                    state = solo21.AutonState.followPath13;
                }
                break;
            ...
            case followPath13:
                ...
                if (follower.getCurrentTValue() > 0.95)
                {
                    startshoot();
                    statetimer.reset();
                    state = solo21.AutonState.shoot13;
                }
                break;
            ...
            case shoot13:
                if (statetimer.seconds() >= 0.7)
                {
                    ...
                    state = solo21.AutonState.followPath16;
                }
                break;

            case followPath16:
                if (!follower.isBusy())
                    state = solo21.AutonState.done;
                break;
