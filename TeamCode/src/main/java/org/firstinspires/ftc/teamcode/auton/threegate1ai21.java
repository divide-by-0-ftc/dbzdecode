...
@Config
@Autonomous(name = "3gate1ai")
public class threegate1ai21 extends DbzOpMode {
    ...
    public static double intakeWait1Dur = 0.5
            ;
...
//                    .setLinearHeadingInterpolation(Math.toRadians(270), Math.toRadians(-134))
            ...
            Path4 = f.pathBuilder()
                    .addPath(new BezierLine(
                            new Pose(57.4,    80.0),
                            new Pose(9.0,  60.7)))
                    .setLinearHeadingInterpolation(Math.toRadians(-131), Math.toRadians(145))
                    .build();

            Path5 = f.pathBuilder()
                    .addPath(new BezierCurve(
                            new Pose(9.0,  60.7),
                            new Pose(31.8,    51.182),
                            new Pose(58.3,    80.0)))
                    .setTangentHeadingInterpolation()
                    .setReversed()
                    .build();
            ...
            Path10 = f.pathBuilder()
                    .addPath(new BezierCurve(
                            new Pose(58.4,    81.3),
                            new Pose(38.448,  84.924),
                            new Pose(23.630,  84.552)))
                    .setTangentHeadingInterpolation()
                    .build();
            ...
            Path11 = f.pathBuilder()
                    .addPath(new BezierLine(
                            new Pose(23.630,  84.552),
                            new Pose(58.6,    80.4)))
                    .setLinearHeadingInterpolation(Math.toRadians(-179), Math.toRadians(-148))
                    .build();

//            Path12 = f.pathBuilder()
//                    .addPath(
//                            new BezierCurve(
//                                    new Pose(55.100, 80.400),
//                                    new Pose(8.848, 54.313),
//                                    new Pose(12.669, 31.569)
//                            )
//                    )
//                    .setTangentHeadingInterpolation()
//                    .build();
...
//                    .build();
            Path12 = f.pathBuilder()
                    .addPath(
                            new BezierCurve(
                                    new Pose(55.100, 80.400),
                                    new Pose(9.848, 58.313),
                                    new Pose(14.669, 16.569)
                            )
                    )
                    .setTangentHeadingInterpolation()
                    .build();
    ...
    public void opLoop() {
        ...
        switch (state) {
            ...
            case shoot1:
                if (!shootStarted && statetimer.seconds() >= shootDelay) {
                    startshoot();
                    shootStarted = true;
                }
                if (shootStarted && statetimer.seconds() >= shootDelay + shootDur) {
                    endshoot();
            ...
            case shoot5:
                ...
                if (shootStarted && statetimer.seconds() >= shootDelay + 0.1 && !turretBump) {
                    turretBump = true;
                    bumpTimer.reset();
                }
                if (shootStarted && statetimer.seconds() >= shootDelay + shootDur) {
            ...
            case shoot9:
                ...
                if (shootStarted && statetimer.seconds() >= shootDelay + 0.7) {
                    endshoot();
            ...
            case shoot11:
                ...
                if (shootStarted && statetimer.seconds() >= shootDelay + 0.5) {
                    endshoot();
            ...
            case shoot13:
                ...
                if (shootStarted && statetimer.seconds() >= shootDelay + 0.3) {
                    endshoot();
    ...
    private void regressions() {
        ...
        switch (state) {
            case shoot1:  case followPath1:                    rawHood = 0.498; rawVel = 1609; break;
            case shoot3:  case followPath3:                    rawHood = 0.53; rawVel = 1570; break;
            case shoot5:                                       rawHood = 0.497; rawVel = 1608; break;
            case shoot7:                                       rawHood = 0.496; rawVel = 1607; break;
            case shoot9:                                       rawHood = 0.496; rawVel = 1607; break;
            case shoot11: case followPath11:                   rawHood = 0.497; rawVel = 1607; break;
            case shoot13: case followPath13:                   rawHood = 0.388; rawVel = 1463; break;
            default:                                           rawHood = 0.497; rawVel = 1608; break;
        }
    ...
    private double getdesiredturretdeg() {
        double base;
        switch (state) {
            case shoot1:  case followPath1:  case followPath2: base =  18; break;
            case shoot3:  case followPath3:  case followPath4: base =  90; break;
            case shoot13: case followPath13:                   base =  92; break;
            case shoot11: case followPath11:                   base =  106; break;
            default:                                           base = 82.5; break;
        }
        if (turretBump) {
