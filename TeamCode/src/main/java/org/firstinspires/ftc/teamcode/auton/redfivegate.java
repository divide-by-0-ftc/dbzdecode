...
//                    .setLinearHeadingInterpolation(Math.toRadians(270), Math.toRadians(-56))
            ...
            Path2 = f.pathBuilder()
                    .addPath(new BezierCurve(
                            new Pose(m(59.5),    78.1),
                            new Pose(m(39.779),  53.834),
                            new Pose(m(11),  63.229)))
                    .setTangentHeadingInterpolation()
                    .build();
            ...
            Path4 = f.pathBuilder()
                    .addPath(new BezierCurve(
                            ...
                            new Pose(m(11),    63.2)))
                    .setLinearHeadingInterpolation(Math.toRadians(-48), Math.toRadians(26))
                    .build();
