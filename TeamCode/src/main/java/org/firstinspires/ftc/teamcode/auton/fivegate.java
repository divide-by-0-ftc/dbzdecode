...
@Config
@Autonomous(name = "5gate")
public class fivegate extends DbzOpMode {
    ...
    public static double intakeWait1Dur = 0.6;
    public static double intakeWait2Dur = 0.6;
    public static double intakeWait3Dur = 0.6;
    public static double intakeWait4Dur = 0.6;
    public static double intakeWait5Dur = 0.6;
...
//                    .setLinearHeadingInterpolation(Math.toRadians(270), Math.toRadians(-124))
            ...
            Path4 = f.pathBuilder()
                    .addPath(new BezierLine(
                            ...
                            new Pose(11.0,    60.3)))
                    .setLinearHeadingInterpolation(Math.toRadians(-132), Math.toRadians(154))
                    .build();
            ...
            Path8 = f.pathBuilder()
                    ...
                    .setLinearHeadingInterpolation(Math.toRadians(-132), Math.toRadians(155))
                    .build();
