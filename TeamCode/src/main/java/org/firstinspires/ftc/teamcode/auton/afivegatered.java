...
@Config
@Autonomous(name = "ared5gate")
public class afivegatered extends DbzOpMode {
    ...
    public static double intakeWait2Dur = 0.5;
    public static double intakeWait3Dur = 0.5;
    public static double intakeWait4Dur = 0.5;
    public static double intakeWait5Dur = 0.5;
...
//                    .setLinearHeadingInterpolation(Math.toRadians(270), Math.toRadians(-56))
            ...
            Path2 = f.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(m(54.900), 77.100),
                                    new Pose(m(41.761), 59.421),
                                    new Pose(m(24.073), 59.468)
                            )
                    ).setTangentHeadingInterpolation()
