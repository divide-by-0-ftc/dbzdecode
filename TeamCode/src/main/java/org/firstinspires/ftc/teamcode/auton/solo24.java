...
@Config
@Autonomous(name = "red24flow")
public class solo24 extends DbzOpMode
{
    ...
    public static double gatex =  144-12.75, gatey = 59.799, gateh = 180+165;
    ...
    public static double hood1  = 0.6, vel1  = 1500, turret1  = 155;
    public static double hood3  = 0.6, vel3  = 1590, turret3  = -140.3;
    public static double hood5  = 0.6, vel5  = 1580, turret5  = -104.5;
    public static double hood7  = 0.6, vel7  = 1580, turret7  = -107.5;
    public static double hood9  = 0.6, vel9  = 1580, turret9  = -107.5;
    public static double hood11 = 0.6, vel11 = 1580, turret11 = -107.5;
    public static double hood13 = 0.6, vel13 = 1580, turret13 = -107.5;

    public static double hood15 = 0.6, vel15 = 1450, turret15 = -107.5;



    public static double hoodrest   = 0.6, velrest   = 1520, turretrest = -107.5;
        ...
        public Paths(Follower f)
        {
            ...
            Path4 = f.pathBuilder()
                    .addPath(new BezierCurve(new Pose(87, 74),
                            new Pose(110.990, 63.89961), new Pose(124.6433, 65.99)))
                    .setTangentHeadingInterpolation().build();
            ...
            Path14 = gatePath(f, shootx, shooty, gatex, gatey);



            Path15 = returnPath(f, gatex, gatey, shootx, shooty);
