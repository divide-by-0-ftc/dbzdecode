...
public class nineplustenblue extends DbzOpMode
{
    ...
    public static double gatex = 144 - 147.1, gatey = 60.2, gateh = 23;
    ...
    public static class Paths
    {
        ...
        public Paths(Follower f)
        {
            ...
            Path12 = f.pathBuilder().addPath(
                            new BezierLine(new Pose(144-97.149, 77.168), new Pose(nearwallx, nearwally)))
                    .setTangentHeadingInterpolation().build();

            Path13 = f.pathBuilder().addPath(
                            new BezierLine(new Pose(nearwallx, nearwally), new Pose(144-100, 112)))
                    .setTangentHeadingInterpolation().setReversed().build();
        }
    }
